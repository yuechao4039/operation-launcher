...
public class LoginTest extends Test {
    ...
    public  void login() throws Exception {
        ...
        // body json数据
        byte[] requestBody = "{\"header\":{\"trcid\":\"d1338c70-19ac-40e1-a459-681c6f90e733\",\"debug\":true},\"data\":{\"userID\":\"1001\",\"userPassword\":\"2002\",\"userType\":\"admin\",\"tenantID\":\"1003\"}}".getBytes(DEFAULT_CHARSET);

        // 写入请求行（协议及版本号,必须是大写的HTTP）
        String requestLine = "POST /api/login.htmls HTTP/1.1" + CRLF;
